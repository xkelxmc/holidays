...
class MyAccountController extends Controller
{
    ...
    {
        $this->data['title'] = trans('profile.my_account');
        $this->data['user'] = $this->guard()->user();

        return view('profile.auth.account.update_info', $this->data);
    }
    ...
    public function postAccountInfoForm(AccountInfoRequest $request)
    {
        ...
        if ($result) {
            Alert::success(trans('profile.account_updated'))->flash();
        } else {
            Alert::error(trans('profile.error_saving'))->flash();
        }
    ...
    public function getChangePasswordForm()
    {
        ...
        return view('profile.auth.account.change_password', $this->data);
    }
